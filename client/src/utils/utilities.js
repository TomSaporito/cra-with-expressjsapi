...
//     var _$el = exactEl? $el : $el.querySelectorAll('[data-lazy-img]');//if this is not the exact element then find those elements
//     Array.prototype.slice.call(_$el).forEach(function(el){
...
function lazyStyles($el, exactEl, position, cb) {
    ...
    var _$el = exactEl? $el : $el.querySelectorAll('[data-lazy-styles]');
