...
import asyncComponent from "./components/_AsyncComponent/_AsyncComponent";
...
const AsyncNavBar = asyncComponent(() => import("./components/_NavBar/_NavBar"));
const AsyncRouter = asyncComponent(() => import("./views/Router/Router.js"));
